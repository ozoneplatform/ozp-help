...
<ol>
	...
	<li>When you are ready to publish the listing, click <img alt="Send the listing to a steward for review" src="/Doc_images/send-to-steward.png"   title="Send the listing to a steward for review" /> to notify the Organizational Steward that the listing is ready for review.&nbsp;You must complete all required fields&nbsp;before submitting the listing.<br />
