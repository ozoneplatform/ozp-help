...
<ol>
	<li>Click the <img alt="List of bookmarks" src="../mocks/Doc_images/+.png" style="height: 20px; width: 20px" title="List of bookmarks" /> in the lower-left corner.</li>
	...
	<img alt="Add bookmarks to your webtop" src="../mocks/Doc_images/Add-Listings-to-Webtop.png" style="height: 248px; width: 624px" title="Use this window to add bookmarks to your webtop" /></li>
