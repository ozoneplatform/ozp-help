...
<h1><a id="MainMenu" name="MenuMenu">Main Menu</a></h1>

<p>The Main Menu is identified by three parallel, stacked, horizontal lines on the right side of the Global Toolbar:&nbsp;<img alt="Main Menu icon" src="../mocks/Doc_images/Main_menu_icon.png" style="border-top: 1px solid; height: 30px; border-right: 1px solid; width: 30px; border-bottom: 1px solid; border-left: 1px solid" /></p>
...
<p><img alt="Main Menu options" src="../mocks/Doc_images/Main_Menu_drop-down_user.png" style="height: 447px; width: 258px" title="Main Menu Options" /></p>
...
<ul>
	...
	<ul>
		...
		<li>Username</li>
		<li>Email</li>
		<li>A list of listings you own. Clicking a listing opens its <a href="Center_listings_overview.html#detailedListingView">Detailed Listing View</a> in Center.<br />
...
<ul>
	<li><b>Submit a Listing</b> takes you to the <a href="Center_listings_create.html#form">Listing Create/Edit Form</a>. Completing the form allows you to submit listings to Center.</li>
...
<p><img alt="Listing Management Page" src="../mocks/Doc_images/ListingManagementPage.png" style="height: 236px; width: 624px" /></p>

<p>See the <a href="Center_listingManagementPage_user.html">Listing Management Page</a> for more information.</p>
