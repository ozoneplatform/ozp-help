...
<p>You access Webtop from the Toolbar. Click the <img alt="Webtop" src="Doc_images/Webtop_icon.png"  title="Webtop icon on the Global Toolbar" /> icon on the left side of the Toolbar:</p>
