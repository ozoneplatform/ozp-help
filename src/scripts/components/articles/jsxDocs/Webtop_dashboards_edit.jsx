...
<ol>
	<li>Click the <img alt="Dashboard access icon" src="../mocks/Doc_images/dashboard-access-icon.png" style="height: 31px; width: 84px" title="Dashboard access icon" /> at the bottom-left side of Webtop&#39;s lower toolbar.</li>
	<li>Click the edit icon beside the dashboard that you want to change:<br />
	<img alt="Edit the dashboard" src="../mocks/Doc_images/dashboard-edit-icon.png" style="height: 225px; width: 233px" title="Edit the dashboard" /></li>
...
<ol>
	<li>Click the <img alt="Dashboard access icon" src="../mocks/Doc_images/dashboard-access-icon.png" style="height: 31px; width: 84px" title="Dashboard access icon" /> at the bottom-left side of Webtop&#39;s lower toolbar.</li>
	<li>Click the trashcan icon beside the dashboard that you want to delete.
	<li>A warning appears, click OK to confirm that you want to delete the dashboard..<br />
