...
<p><img alt="Lower toolbar in Webtop" src="../mocks/Doc_images/webtop-lower-toolbar.png" style="height: 33px; width: 624px" title="Lower toolbar in Webtop" /><br />
&nbsp;</p>
...
<table border="1" cellpadding="2" cellspacing="0" style="height: 172px; width: 647px; text-align: left">
	<tbody>
		...
		<tr>
			<td><img alt="List of all open bookmarks" src="../mocks/Doc_images/+.png" style="height: 20px; width: 20px" title="List of all open bookmarks" /></td>
			<td>Opens a window that lists all the listings you bookmarked to HUD</td>
		</tr>
		<tr>
			<td><img alt="Dashboard access icon" src="../mocks/Doc_images/dashboard-access-icon.png" style="height: 31px; width: 84px" title="Dashboard access icon" /></td>
			<td>Opens access to your dashboards. From here you can switch dashboards; and create, edit or delete them.</td>
		</tr>
		<tr>
			<td><img alt="Small listing icons" src="../mocks/Doc_images/small-listing-icons-on-webtop.png" style="height: 43px; width: 84px" title="Small listing icons" /></td>
			<td>Small icons that identify listings that are open on the dashboard. 
			<ul> 
		...
		<tr>
			<td><img alt="Cascading window format" src="../mocks/Doc_images/cascading-window-format-icon.png" style="height: 28px; width: 28px" title="Cascading window format" /></td>
			<td>On desktop dashboards, the square icon moves all listings into a cascading window format.</td>
		</tr>
		<tr>
			<td><img alt="Make webtop full screen" src="../mocks/Doc_images/full-screen-icon.png" style="height: 26px; width: 28px" title="Webtop full screen icon" /></td>
...
<ul style="margin-left: 40px">
	<li><a href="Webtop_addListing.html">Add Listings to Webtop</a></li>
