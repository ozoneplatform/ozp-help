...
<p><img alt="Lower toolbar in Webtop" src="Doc_images/webtop-lower-toolbar.png"  title="Lower toolbar in Webtop" /><br />
&nbsp;</p>
...
<table border="1" cellpadding="2" cellspacing="0" >
	<tbody>
		...
		<tr>
			<td><img alt="List of all open bookmarks" src="Doc_images/+.png"  title="List of all open bookmarks" /></td>
			<td>Opens a window that lists all the listings you bookmarked to HUD</td>
		</tr>
		<tr>
			<td><img alt="Dashboard access icon" src="Doc_images/dashboard-access-icon.png"  title="Dashboard access icon" /></td>
			<td>Opens access to your dashboards. From here you can switch dashboards; and create, edit or delete them.</td>
		</tr>
		<tr>
			<td><img alt="Small listing icons" src="Doc_images/small-listing-icons-on-webtop.png"  title="Small listing icons" /></td>
		...
		<tr>
			<td><img alt="Cascading window format" src="Doc_images/cascading-window-format-icon.png"  title="Cascading window format" /></td>
			<td>On desktop dashboards, the square icon moves all listings into a cascading window format.</td>
		</tr>
		<tr>
			<td><img alt="Make webtop full screen" src="Doc_images/full-screen-icon.png"  title="Webtop full screen icon" /></td>
